...
public class AmenityController {
    ...
    public ResponseEntity<ApiResponse> addAmenity(@RequestBody AddAmenityRequest request) {
        try {
            ...
            return ResponseEntity.ok(new ApiResponse("Success add new amenity", convertedAmenity));
        } catch (Exception e) {
    ...
    public ResponseEntity<ApiResponse> updateAmenity(@RequestBody UpdateAmenityRequest request, @PathVariable Long amenityId) {
        try {
    ...
    public ResponseEntity<ApiResponse> deleteAmenity(@PathVariable Long amenityId) {
        try {
